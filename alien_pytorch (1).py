...
class Custom_Dataset(Dataset):
  def __init__(self, image_dir, label_dir, transform=None):
    ...
    self.label_files = [file for file in os.listdir(label_dir) if file.endswith('.txt')]
...
#train_image_dir = os.path.join(extract_path, 'train', 'images')
#train_label_dir = os.path.join(extract_path, 'train', 'labels')
#test_image_dir = os.path.join(extract_path, 'test', 'images')
